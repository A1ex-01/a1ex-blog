    ...
    <Drawer open>
      <DrawerContent>
        <div className="min-w-screen h-[90vh] overflow-y-scroll relative">
          <div
            onClick={() => router.back()}
            className="close sticky top-4 my-4 w-full flex justify-end cursor-pointer"
          >
            <Icon icon="line-md:close-circle-twotone" className="text-3xl text-danger-500 mr-8" />
          </div>
