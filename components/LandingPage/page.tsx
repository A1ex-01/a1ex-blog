...
export default function LandingPage() {
  ...
  const fetchCharacters = async () => {
    const list = [
      ...
      },
      {
        ...
        model_preview:
          "https://static.bestie.icu/friendchat/cover/modelpreview20241217/scarlette.png",
        relationship_options: [
          {
            is_vip_can: false,
            key: "Friend",
        ...
        bot_model_topic_config: [
          {
            bot_model_uuid: "f546a92e-1c67-4a8b-bb49-85a5d8f17ad3",
            content:
              "I'm so tired of working hard. I just want to be a sugar baby, lol! lololol 😝",
  ...
  const navs = [
    {
      ...
      sub: "HOMEPAGE",
      href: "#HOMEPAGE",
      icon: <Icon icon={"icon-park-outline:home"} width={28} height={28} />
    },
    {
      title: "キャラクター",
      sub: "PERSONA",
      href: "#PERSONA",
      icon: <Icon icon={"icon-park-outline:children-cap"} width={28} height={28} />
    },
    {
      title: "チャットデモ",
      sub: "CHARACTER CHAT",
      href: "#CHARACTERCHAT",
      icon: <Icon icon={"icon-park-outline:message-emoji"} width={28} height={28} />
    },
    {
      title: "ユーザーレビュー",
      sub: "VOICE OF THE USER",
      href: "#VOICE",
      icon: <Icon icon={"icon-park-outline:star"} width={28} height={28} />
    },
    {
      title: "機能ガイド",
      sub: "FUNCTION INTRODUCTION",
      href: "#FUNCTIONINTRODUCTION",
      icon: <Icon icon={"icon-park-outline:application-one"} width={28} height={28} />
    }
  ];
  ...
  return (
    <div ref={wrapperRef} className="w-full relative h-full overflow-y-scroll">
      <NavBar currHref={currHref} setCurrHref={setCurrHref} navItems={navs} />
      <section
        id="HOMEPAGE"
        ref={HOMEPAGERef}
      ...
      <div className="placeholder relative h-[500%]">
        ...
        >
          ...
          >
            ...
            <div className="line left-4 right-4 h-[2px] bg-[#8f61b3] absolute top-2">
              <Icon icon={"tabler:quote-filled"} className="text-[#8f61b3]" />
            </div>
            <div
              style={{
                writingMode: "tb"
